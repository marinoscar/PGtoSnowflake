import type { PgTableMetadata } from '../types/postgres.js';
import type { SnowflakeForeignKey } from '../types/snowflake.js';
...
function generateHeader(): string {
  return `-- ============================================================
-- Snowflake DDL generated by pgtosnowflake
...
function generateTableDDL(table: PgTableMetadata): string {
...
function generateForeignKeys(tables: PgTableMetadata[]): { sql: string; foreignKeys: SnowflakeForeignKey[] } {
...
export async function generateDDL(tables: PgTableMetadata[]): Promise<GenerateDDLResult> {
  try {
